...
export interface Oeth_vaultInterface extends utils.Interface {
  functions: {
    ...
    "priceUnitMint(address)": FunctionFragment;
    "priceUnitRedeem(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "priceUnitMint",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "priceUnitRedeem",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface Oeth_vault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Oeth_vaultInterface;
