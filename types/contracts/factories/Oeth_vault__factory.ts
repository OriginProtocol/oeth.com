...
import type { Oeth_vault, Oeth_vaultInterface } from "../Oeth_vault";
...
export class Oeth_vault__factory {
  static readonly abi = _abi;
  static createInterface(): Oeth_vaultInterface {
    return new utils.Interface(_abi) as Oeth_vaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Oeth_vault {
    return new Contract(address, _abi, signerOrProvider) as Oeth_vault;
  }
}
